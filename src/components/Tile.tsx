...
export function Tile({
    ...
    {
        let tileTyleStyle;
        if (isStart)  tileTyleStyle = START_TILE_STYLE;
        
        else if (isEnd) tileTyleStyle = END_TILE_STYLE;
        else if (isTraversed) tileTyleStyle = TRAVERSED_TILE_STYLE;
        else if (isWall) tileTyleStyle = WALL_TILE_STYLE;
        else if (isPath) tileTyleStyle = PATH_TILE_STYLE;
        else tileTyleStyle = TILE_STYLE;
